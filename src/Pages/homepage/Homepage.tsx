    ...
    return (
        <>
            ...
            <Menu
                ...
                <Grid>
                    <Stack sx={{height: '532px', marginBottom : '10px', overflowY : 'scroll'}} spacing={2} direction="column">
                        <OtherMessageComponent/>
                        <MyMessageComponent/>
                    </Stack>
                    <Grid wrap='nowrap'>
                        <CssTextField
                            sx={{marginLeft : '9px', marginRight : '5px', width: '323px',
                        ...
                        <Button className='sendButton'
                                sx={{background : '#7EB503', width : '40px', height : '40px', borderRadius : '15px', marginRight : '9px'}}>
            ...
            >
                <Grid>
                    <Box
                        sx={{borderRadius : '15px 15px 5px 5px', backgroundColor : '#534341', height : '71px',
                        marginTop : '-3px', marginLeft : '5px', marginRight : '5px'}}>
                        <Grid
                            container
                            style={{justifyContent: "start"}}>
                            <Avatar
                                sx={{backgroundColor: '#008fdb', marginTop : '13px', marginLeft : '13px',
                                    height : '40px', width : '40px', fontSize : '25px'}}>M</Avatar>
                            <Grid>
                                <Typography
                                    sx={{fontFamily : 'Roboto Black', color : 'white', fontSize : '16px',
                                        marginTop : '10px',
                                        marginLeft : '10px'}}>Carlo</Typography>
                                <Typography
                                    sx={{color : 'white', fontSize : '12px', marginLeft : '10px',
                                    fontFamily : 'Roboto Light'}}>prova@gmail.com</Typography>
                            </Grid>
                            <Box className='exitPopUpIcon'
                                sx={{backgroundColor : '#ba1a1a', borderRadius : '13px', marginTop : '12px',
                                marginLeft : '120px',
                                width : '47px',
                                height : '47px',}}>
                                <LogoutIcon sx={{color : '#ffffff', marginTop : '12px', fontSize : '22px',
                                    marginLeft : '15px'}}></LogoutIcon>
                            </Box>
                        </Grid>
                    </Box>
                    <Box className='loginOtherAccountPopUp'
                        sx={{borderRadius : '5px 5px 15px 15px', height : '35px', marginTop : '3px',
                        marginLeft : '5px',
                        marginRight: '5px'}}>
                        <Grid container>
                            <LoginIcon sx={{color : 'white', marginTop : '5px', marginLeft : '18px'}}></LoginIcon>
                            <Typography sx={{color : 'white', fontFamily : 'Roboto Regular', fontSize : '15px',
                                marginTop : '6px',
                                marginLeft : '10px'}}>Log-In with another account</Typography>
                        </Grid>
                    </Box>
                </Grid>
            </Menu>
